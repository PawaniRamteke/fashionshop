    ...
    <body>
        ...
        <header class="l-header">
            <nav class="nav bd-grid">
                <div>
                    <a href="" class="nav__logo">PAWANI</a>
                </div>
                ...
                <div class="featured__container bd-grid">
                    <div class="featured__product">
                        ...
                        <div class="featured__data">
                            ...
                            <span class="featured__price">₹2,427</span>
                        </div>
                    </div>
                    ...
                    <div class="featured__product">
                        ...
                        <div class="featured__data">
                            ...
                            <span class="featured__price">₹16,660</span>
                        </div>
                    </div>
                    ...
                    <div class="featured__product">
                        ...
                        <div class="featured__data">
                            ...
                            <span class="featured__price">₹10,214</span>
                        </div>
                    </div>
                    ...
                    <div class="featured__product">
                        ...
                        <div class="featured__data">
                            ...
                            <span class="featured__price">₹8,288</span>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <footer class="footer section">
            <div class="footer__container bd-grid">
                <div class="footer__box">
                    <h3 class="footer__title">PAWANI</h3>
